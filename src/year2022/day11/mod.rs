    ...
    fn part1(&self, input: &ProblemInput) -> Result<usize> {
        let monkeys = vec![
            Monkey {
                ...
                operation: |x| x * 17,
                test: |x| if x % 3 == 0 { 3 } else { 6 },
                inspections: 0,
            },
            Monkey {
                items: vec![63, 83, 50, 63, 56],
                operation: |x| x + 2,
                test: |x| if x % 13 == 0 { 3 } else { 0 },
                inspections: 0,
            },
            Monkey {
                items: vec![93, 79, 74, 55],
                operation: |x| x + 1,
                test: |x| if x % 2 == 0 { 0 } else { 1 },
                inspections: 0,
            },
            Monkey {
                items: vec![86, 61, 67, 88, 94, 69, 56, 91],
                operation: |x| x + 7,
                test: |x| if x % 11 == 0 { 6 } else { 7 },
                inspections: 0,
            },
            Monkey {
                items: vec![76, 50, 51],
                operation: |x| x * x,
                test: |x| if x % 19 == 0 { 2 } else { 5 },
                inspections: 0,
            },
            Monkey {
                items: vec![77, 76],
                operation: |x| x + 8,
                test: |x| if x % 17 == 0 { 2 } else { 1 },
                inspections: 0,
            },
            Monkey {
                items: vec![74],
